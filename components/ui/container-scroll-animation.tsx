...
export const Card = ({ rotate, scale, children }: { rotate: MotionValue<number>; scale: MotionValue<number>; translate: MotionValue<number>; children: React.ReactNode; }) => (
    <motion.div
        ...
        className="max-w-5xl -mt-12 mx-auto h-[30rem] md:h-[40rem] w-full border-4 border-blue-200 dark:border-slate-700 p-2 md:p-6 bg-white dark:bg-slate-900 rounded-[30px] shadow-2xl"
    >
        <div className="h-full w-full overflow-hidden rounded-2xl bg-gray-50 dark:bg-slate-800 md:rounded-2xl md:p-4">
            {children}
        </div>
    </motion.div>
);
